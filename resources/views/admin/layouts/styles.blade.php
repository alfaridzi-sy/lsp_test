...
<link href="{{ asset('master/assets/js/plugins/font-awesome-4.7.0/css/font-awesome.min.css') }}" rel="stylesheet" />
<!-- CSS Files -->
<link href="{{ asset('master/assets/css/argon-dashboard.css?v=1.1.0') }}" rel="stylesheet" />
{{-- <link href="{{ asset('master/assets/js/plugins/dist/css/bootstrap.min.css') }}" rel="stylesheet" /> --}}
